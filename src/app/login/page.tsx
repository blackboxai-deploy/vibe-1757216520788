...
export default function LoginPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <h1 className="text-3xl font-bold mb-8">Login to NutriAI</h1>
       <div className="w-full max-w-xs">
        ...
        Don't have an account? <Link href="/signup" className="text-blue-500 hover:text-blue-800">Sign up</Link>
        </p>
      </div>
    </div>
  );
